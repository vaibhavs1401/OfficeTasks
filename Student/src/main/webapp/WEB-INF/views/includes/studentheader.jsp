<%-- 
    ...
    Created on : 13-Oct-2025, 3:41:13 pm
    Author     : hcdc
--%>
...
<header class="site-header">
  <nav class="nav-bar container">
    <div class="nav-links">
      ...
      <a href="<c:url value='/student/uploadfiles'/>" class="nav-link">Upload Files</a>
      <a href="<c:url value='/student/myfiles'/>" class="nav-link">My Files</a>
    </div>
